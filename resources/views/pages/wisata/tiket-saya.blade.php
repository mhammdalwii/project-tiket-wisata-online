    ...
    <div class="space-y-6">
            ...
            <div class="bg-white border border-gray-200 rounded-xl shadow-sm p-5 md:p-6 flex flex-col md:flex-row md:items-center justify-between hover:shadow-md transition">
                ...
                <div class="flex-1 mb-4 md:mb-0">
                    <div class="flex justify-between items-start md:block mb-2">
                        ...
                        <div class="md:hidden">
                            ...
                            @elseif ($tiket->status === 'Menunggu Konfirmasi')
                    ...
                    <h3 class="text-xl font-bold text-gray-800 mb-1">{{ $tiket->destinasi }}</h3>
                    <p class="text-sm text-gray-600 flex items-center gap-1">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-gray-400" viewBox="0 0 20 20" fill="currentColor">
                            <path fill-rule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clip-rule="evenodd" />
                        </svg>
                        {{ $tiket->tanggal }} &bull; {{ $tiket->jumlah }} Tiket
                    </p>
                </div>
                ...
                <div class="flex flex-col md:items-end justify-between border-t md:border-t-0 border-gray-100 pt-4 md:pt-0">
                    ...
                    <div class="hidden md:block mb-3">
                        ...
                        @elseif ($tiket->status === 'Menunggu Konfirmasi')
                            <span class="px-3 py-1 bg-orange-100 text-orange-700 text-xs font-bold rounded-full inline-block">Menunggu Konfirmasi</span>
                        @else
                    ...
                    <div class="flex items-center justify-between md:flex-col md:items-end w-full">
                        <span class="text-lg font-bold text-gray-900 mb-2">Rp {{ number_format($tiket->total, 0, ',', '.') }}</span>
                        
                        <!-- Tombol Aksi -->
                        @if ($tiket->status === 'Lunas')
                            <!-- Jika Lunas, bisa lihat E-Ticket -->
                            <a href="{{ route('wisata.eticket') }}" class="text-sm bg-blue-600 text-white font-semibold py-2 px-4 rounded-md hover:bg-blue-700 transition">
                                Lihat E-Ticket
                            </a>
                        @elseif ($tiket->status === 'Menunggu Konfirmasi')
                            <!-- Jika Menunggu, tombol di-disable -->
        ...
        @empty
            <div class="bg-gray-50 border border-dashed border-gray-300 rounded-xl p-10 text-center">
                ...
                <a href="{{ route('wisata.index') }}" class="inline-block bg-blue-600 text-white font-bold py-2 px-6 rounded-md hover:bg-blue-700 transition">
